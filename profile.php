...
$sql = "SELECT * FROM members where id='8'";
...
<ul class="collection">
	<li class="collection-item avatar">
      ...
      <p><?php echo $disp_currentcity ?><!--Current City:Banglore--> <br>
         <?php echo $disp_firstname $disp_lastname ?><!--Home Town:Delhi-->
      </p>
    ...
    <li class="collection-item avatar">
      ...
      <p><?php echo $disp_dob ?><!--August,19.--><br>
    ...
    <li class="collection-item avatar">
      ...
      <p><?php echo $disp_telephone ?><!--Phone:9758426525>--><br>
         <?php echo $disp_mail ?><!--E-mail:xyz@gmail.com--><br>
		 Other Accounts:<br>
      </p>
      <a href="#!" class="secondary-content"><i class="material-icons">grade</i></a>
    </li>
    <li class="collection-item avatar">
      ...
      <p><?php echo $disp_school ?><!--School:St. Stephen's School,Delhi--> <br>
         <?php echo $disp_college ?><!--College:Delhi University--><br>
